...
const actionDefinitions: GameActionDefinition[] = [
    ...
    { id: 'action.manualMoveAgent', label: 'Manual Move Agent', category: 'move', commandType: 'MANUAL_MOVE_AGENT', target: 'agent', payloadFields: ['agentId', 'x', 'z'], description: 'Directly moves an agent through manual control.' },
