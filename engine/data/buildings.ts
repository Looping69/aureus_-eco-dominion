...
export const BUILDINGS: Record<BuildingType, BuildingDef> = {
    ...
    [BuildingType.RESERVOIR]: {
        ...
        costs: { agt: 5000, stone: 1200, minerals: 350 },
        era: Era.SUSTAINABILITY,
        power: { consumes: 2 },
        water: { produces: 50 },
        waterPlaceable: true,
    ...
    [BuildingType.SOLAR_ARRAY]: {
        ...
        maintenance: 2,
        pollution: -2.0,
        costs: { agt: 500, stone: 150, minerals: 40 },
        era: Era.SETTLEMENT,
        power: { produces: 5 },
        upgrades: [
            {
    ...
    [BuildingType.WATER_WELL]: {
        ...
        production: 2,
        productionType: 'TRUST',
        costs: { agt: 1200, wood: 200, stone: 250 },
        era: Era.SETTLEMENT,
        water: { produces: 10 },
        waterPlaceable: true,
        upgrades: [
    ...
    [BuildingType.WIND_TURBINE]: {
        ...
        maintenance: 3,
        pollution: -6.0,
        costs: { agt: 2500, wood: 300, stone: 500, minerals: 120 },
        era: Era.GROWTH,
        power: { produces: 8 },
        upgrades: [
            {
