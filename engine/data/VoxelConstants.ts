    ...
    upgrades: [
      {
        level: 2,
        name: 'Prefab Housing',
        description: 'Container-style modular units with better comfort.',
        statsDiff: '+Capacity, +Comfort',
        costs: { agt: 2000, minerals: 50 },
        era: Era.GROWTH,
        power: { consumes: 2 },
        water: { consumes: 2 },
        maintenance: 4,
      },
      {
        level: 3,
        name: 'Row Housing',
        description: 'Brick apartments with reliable utilities.',
        statsDiff: '+Capacity, +Privacy',
        costs: { agt: 5000, minerals: 120 },
        era: Era.INDUSTRY,
        power: { consumes: 4 },
        water: { consumes: 3 },
        maintenance: 8,
      },
      {
        ...
        description: 'High-rise living with efficient shared infrastructure.',
        statsDiff: '+Capacity, +Eco Living',
        costs: { agt: 15000, minerals: 300, gems: 20 },
        era: Era.SUSTAINABILITY,
        power: { consumes: 6 },
        water: { consumes: 4 },
        maintenance: 12,
    ...
    upgrades: [
      {
        level: 2,
        name: 'Mess Hall',
        description: 'Covered communal dining with a proper service line.',
        statsDiff: 'Faster Hunger Recovery',
        costs: { agt: 1500, minerals: 40 },
        era: Era.GROWTH,
        power: { consumes: 4 },
        water: { consumes: 3 },
        maintenance: 6,
      },
      {
        level: 3,
        name: 'Dining Complex',
        description: 'Dedicated kitchen block with improved food throughput.',
        statsDiff: '+Mood from Meals',
        costs: { agt: 4000, minerals: 120 },
        era: Era.INDUSTRY,
        power: { consumes: 6 },
        water: { consumes: 5 },
        maintenance: 10,
      },
      {
        level: 4,
        name: 'Gourmet Bistro',
        description: 'Modern cafeteria with hydroponic service garden.',
        statsDiff: 'Premium Meals, +Trust',
        costs: { agt: 12000, minerals: 300, gems: 15 },
        era: Era.SUSTAINABILITY,
        power: { consumes: 8 },
        water: { consumes: 6 },
        maintenance: 15,
    ...
    upgrades: [
      {
        level: 2,
        name: 'Social Dome',
        description: 'Glass-enclosed community dome with better facilities.',
        statsDiff: '+Mood, +Trust',
        costs: { agt: 2500, minerals: 60 },
        era: Era.GROWTH,
        maintenance: 8,
        production: 2,
      },
      {
        level: 3,
        name: 'Civic Plaza',
        description: 'Expanded social complex with linked gathering spaces.',
        statsDiff: 'Rapid Mood Recovery',
        costs: { agt: 8000, minerals: 200 },
        era: Era.INDUSTRY,
        maintenance: 15,
        power: { consumes: 4 },
        production: 5,
      },
      {
        level: 4,
        name: 'Grand Atrium',
        description: 'High-tech cultural center with central projection core.',
        statsDiff: 'Max Mood, +Trust',
    ...
    upgrades: [
      {
        ...
        description: 'Taller reinforced tower with better visibility.',
        statsDiff: '+Trust, Wider Sight',
      ...
      },
      {
        level: 3,
        name: 'Armored Bunker',
        description: 'Reinforced concrete post with stronger coverage.',
        statsDiff: '+Trust, +Radar',
      ...
      },
      {
        level: 4,
        name: 'Sensor Spire',
        description: 'Modern sensor and drone surveillance platform.',
        statsDiff: '+Trust, Global Scan',
    ...
    upgrades: [
      {
        ...
        description: 'Rotating drum setup with better ore separation.',
        statsDiff: '+50 Min/s',
        costs: { agt: 3000, minerals: 80 },
        era: Era.GROWTH,
        power: { consumes: 8 },
        water: { consumes: 8 },
        maintenance: 15,
      ...
      },
      {
        ...
        description: 'Industrial screening plant with improved throughput.',
        statsDiff: '+80 Min/s',
        costs: { agt: 10000, minerals: 250 },
        era: Era.INDUSTRY,
        power: { consumes: 12 },
        water: { consumes: 12 },
        maintenance: 25,
      ...
      },
      {
        ...
        description: 'Automated high-pressure cleaning facility.',
        statsDiff: '+120 Min/s, -Pollution',
        costs: { agt: 30000, minerals: 800, gems: 40 },
        era: Era.SUSTAINABILITY,
        power: { consumes: 20 },
        water: { consumes: 15 },
        maintenance: 40,
    ...
    upgrades: [
      {
        ...
        description: 'Reinforced frames with improved photovoltaic cells.',
        statsDiff: '+10 Power',
      ...
      },
      {
        ...
        description: 'Sun-tracking array with better daily yield.',
        statsDiff: '+20 Power',
      ...
      },
      {
        ...
        description: 'Advanced concentrator tower with dense output.',
        statsDiff: '+50 Power',
    ...
    upgrades: [
      {
        ...
        description: 'Organized wooden beds with basic irrigation.',
        statsDiff: '+Trust, -Pollution',
        costs: { agt: 1200, minerals: 30 },
        era: Era.GROWTH,
        maintenance: 5,
        production: 8,
        pollution: -2.0,
      },
      {
        ...
        description: 'Structured civic garden with fountain centerpiece.',
        statsDiff: '+Trust, Better Eco',
        costs: { agt: 4000, minerals: 120 },
        era: Era.INDUSTRY,
        maintenance: 10,
        production: 15,
      ...
      },
      {
        ...
        description: 'Enclosed modern biodome with high ecological return.',
        statsDiff: '+Trust, Major Eco Gain',
        costs: { agt: 15000, minerals: 500, gems: 25 },
        era: Era.SUSTAINABILITY,
        maintenance: 20,
        production: 30,
        pollution: -10.0,
    ...
    upgrades: [
      {
        ...
        description: 'Mechanical pump with stronger draw rate.',
        statsDiff: '+20 Water',
        costs: { agt: 2000, minerals: 40 },
        era: Era.GROWTH,
        water: { produces: 20 },
        maintenance: 8,
      },
      {
        ...
        description: 'Industrial pump house with steady pressure.',
        statsDiff: '+40 Water',
        costs: { agt: 6000, minerals: 200 },
        era: Era.INDUSTRY,
        power: { consumes: 2 },
        water: { produces: 40 },
        maintenance: 12,
      },
      {
        ...
        description: 'Integrated treatment and pumping tower.',
        statsDiff: '+80 Water, +Trust',
        costs: { agt: 20000, minerals: 500, gems: 30 },
        era: Era.SUSTAINABILITY,
        power: { consumes: 5 },
        water: { produces: 80 },
        maintenance: 20,
    ...
    upgrades: [
      {
        ...
        description: 'Refined tower and blade geometry for better output.',
        statsDiff: '+15 Power',
      ...
      },
      {
        ...
        description: 'Heavy-duty twin-rotor generation platform.',
        statsDiff: '+40 Power',
      ...
      },
      {
        ...
        description: 'Advanced spiral turbine with dense renewable output.',
        statsDiff: '+100 Power',
