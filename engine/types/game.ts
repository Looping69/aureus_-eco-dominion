...
export type GameCommandType =
    | 'PLACE_BUILDING' | 'BULLDOZE' | 'BULLDOZE_SUB' | 'SPEED_UP' | 'REHABILITATE' | 'UPGRADE_BUILDING' | 'EXPLODE_TILE' | 'DIG_VOXEL' | 'CLEAR_RUBBLE' | 'DESIGNATE_RUBBLE_DUMP' | 'FILL_VOXEL' | 'COMMAND_AGENT' | 'COMMAND_AGENTS' | 'MANUAL_MOVE_AGENT' | 'COMBAT_ATTACK_TARGET' | 'COMBAT_HOLD_POSITION' | 'COMBAT_CLEAR_ORDERS' | 'BUY_BUILDING' | 'PLACE_SUB_BUILDING' | 'SELL_RESOURCE' | 'BUY_RESOURCE' | 'SET_AUTO_SELL' | 'MARK_HARVEST' | 'RESEARCH_TECH' | 'ACCEPT_CONTRACT' | 'DELIVER_CONTRACT' | 'ABANDON_CONTRACT' | 'ADVANCE_TUTORIAL' | 'START_DEMO' | 'DISMISS_POPUP' | 'SUBMIT_PERMIT' | 'TALK_TO_NPC' | 'CHOOSE_DIALOGUE' | 'CLOSE_DIALOGUE' | 'SET_AI_OVERSEER'
    | (string & {});
